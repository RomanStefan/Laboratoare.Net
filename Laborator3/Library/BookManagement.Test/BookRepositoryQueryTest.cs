...
namespace BookManagement.Test
{
    ...
    public class BookRepositoryQueryTest
    {
        ...
        public void RetrieveOrderByYearAscending()
        {
            ...
            var result1 = books.RetriveAllOrderByYearAscending().First().Title.Should().Be("The Mysterious Affair at Styles");
        }
        ...
        private BookRepositoryQuery CreateBooksRepository()
        {
            var bookRepository = new BookRepositoryQuery(
                new List<Book>
                {
